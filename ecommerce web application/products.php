...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to SELL ME AGAIN!</h1>
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/book1.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/book2.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Engineering Drawing by N.D. Bhatt</h6>
                    <h6>Price :Rs 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/book3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Basic Electrical Engineering</h6>
                    <h6>Price :Rs 3500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/book4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/calculator1.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>FX-300MS</h6>
                    <h6>Price :Rs 800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/calculator2.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>991ES Plus</h6>
                    <h6>Price :Rs 600</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/calculator3.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>fx_991 MS</h6>
                        <h6>Price :Rs 500</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/calculator4.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>fx-38GT</h6>
                        <h6>Price :Rs 600</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/laptop.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Acer</h6>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/dell XPS.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Dell XPS 17 9700</h6>
                            <h6>Price :Rs 55000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/Dell inspiration.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Dell inspiration 15 3521</h6>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/laptophp.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>HP Envy 15-Fh0019au X360 AMD Ryzen</h6>
                    <h6>Price :Rs 60000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="row text-center" id="headphones">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/coat1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Lab Coat</h6>
                                <h6>Price :Rs 250</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/graphics.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Graphic tools</h6>
                                <h6>Price :Rs 100</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/mini drafter.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Mini Drafter</h6>
                                <h6>Price :Rs 50</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/roller scale.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Roller Scale</h6>
                                <h6>Price :Rs 20</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
