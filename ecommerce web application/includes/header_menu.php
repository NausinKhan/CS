...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">SELL ME AGAIN</a>
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">BOOKS</a>
                                   <a href="products.php#shirt" class="dropdown-item">CALCULATORS</a>
                                   <a href="products.php#shoes" class="dropdown-item">LAPTOPS</a>
                                   <a href="products.php#headphones" class="dropdown-item">GRAPHICS TOOLS</a>
                       ...
                       <li class="nav-item"><a href="1.html" class="nav-link" target="_blank">Chat</a></li>
                       <?php
